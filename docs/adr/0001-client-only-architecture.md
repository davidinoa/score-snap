...
- If a server ever comes, the principle evolves from "nothing leaves the device" to "end-to-end-encrypted sync; recognition still on-device." Server-side *recognition* stays off the table regardless (PRD principle #1).
